...
export const ABNT2_NUMPAD: KeyData[] = [
  { id: 'np_numlock', code: 'NumLock', primaryLabel: 'NumLock', widthUnits: 1, category: 'numpad' },
  { id: 'np_numdiv', code: 'NumpadDivide', primaryLabel: '/', widthUnits: 1, category: 'numpad' },
  { id: 'np_nummult', code: 'NumpadMultiply', primaryLabel: '*', widthUnits: 1, category: 'numpad' },
  { id: 'np_numsub', code: 'NumpadSubtract', primaryLabel: '-', widthUnits: 1, category: 'numpad' },
  { id: 'np_num7', code: 'Numpad7', primaryLabel: '7', shiftLabel: 'Home', widthUnits: 1, category: 'numpad' },
  { id: 'np_num8', code: 'Numpad8', primaryLabel: '8', shiftLabel: '▲', widthUnits: 1, category: 'numpad' },
  { id: 'np_num9', code: 'Numpad9', primaryLabel: '9', shiftLabel: 'PgUp', widthUnits: 1, category: 'numpad' },
  { id: 'np_numadd', code: 'NumpadAdd', primaryLabel: '+', widthUnits: 1, heightUnits: 2, category: 'numpad' },
  { id: 'np_num4', code: 'Numpad4', primaryLabel: '4', shiftLabel: '◀', widthUnits: 1, category: 'numpad' },
  { id: 'np_num5', code: 'Numpad5', primaryLabel: '5', widthUnits: 1, category: 'numpad' },
  { id: 'np_num6', code: 'Numpad6', primaryLabel: '6', shiftLabel: '▶', widthUnits: 1, category: 'numpad' },
  { id: 'np_num1', code: 'Numpad1', primaryLabel: '1', shiftLabel: 'End', widthUnits: 1, category: 'numpad' },
  { id: 'np_num2', code: 'Numpad2', primaryLabel: '2', shiftLabel: '▼', widthUnits: 1, category: 'numpad' },
  { id: 'np_num3', code: 'Numpad3', primaryLabel: '3', shiftLabel: 'PgDn', widthUnits: 1, category: 'numpad' },
  { id: 'np_numenter', code: 'NumpadEnter', primaryLabel: 'Enter', widthUnits: 1, heightUnits: 2, category: 'numpad' },
  { id: 'np_num0', code: 'Numpad0', primaryLabel: '0', shiftLabel: 'Ins', widthUnits: 2, category: 'numpad' },
  { id: 'np_numdot', code: 'NumpadDecimal', primaryLabel: ',', shiftLabel: 'Del', widthUnits: 1, category: 'numpad' },
];
